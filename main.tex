...
\textbf{Deep Learning}\\
{\LARGE Thang Long MedAI Brain, Thang Long University}\par % Book title
\vspace*{1cm}
{\Huge Thang Nguyen}\par % Author name
\endgroup
...
\noindent \textsc{Nhóm nghiên cứu Thang Long MedAI Brain, Thang Long University}\\

%\noindent \textsc{github.com/LaurethTeX/Clustering}\\ % URL

\noindent Quyển sách này được viết ra phục vụ mục đích sử dụng nội bộ trong nhóm nghiên cứu Thang Long MedAI Brain, Đại học Thăng Long. Và quyển sách này được viết chủ yếu dựa trên quyển sách \textit{"Deep Learning, Ian Goodfellow and Yoshua Bengio and Aaron Courville, 2016"}\\ % License information
i
\noindent \textit{Tái bản đầu tiên, Tháng tám 2017} % Printing/edition date
